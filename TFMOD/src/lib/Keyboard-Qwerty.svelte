<script lang="ts">
	...
	import { keySize, keySizeH, keySizeW } from "./KeySize.js";
...
<div class="keyboard" style={`--totalSize:${top(true)}`}>
	...
	<Key keycode="PGDN" left={repeat(false, halfAlmost)} top={top()} width={almostDouble + "px"}>Page<br/>Down</Key>
	<Key keycode="KP_HOME" left={repeat(false, size)} top={top()}>7</Key>
	<Key keycode="KP_UPARROW" left={repeat()} top={top()}>8</Key>
	<Key keycode="KP_PGDN" left={repeat()} top={top()}>9</Key>
	...
	<Key keycode="KP_LEFTARROW" left={repeat(false, (size + gap + gap) + half + ((almostDouble + gap) * 3) + half)} top={top()}>4</Key>
	<Key keycode="KP_5" left={repeat()} top={top()}>5</Key>
	<Key keycode="KP_RIGHTARROW" left={repeat()} top={top()}>6</Key>
	...
	<Key keycode="KP_LEFTARROW" left={repeat(false, almostDouble + size - gap)} top={top()}>4</Key>
	<Key keycode="KP_5" left={repeat()} top={top()}>5</Key>
	<Key keycode="KP_RIGHTARROW" left={repeat()} top={top()}>6</Key>
	...
	<Key keycode="KP_INS" left={repeat(false, almostDouble - gap)} top={top()}>0</Key>
	<Key keycode="KP_DOWNARROW" left={repeat()} top={top()}>5</Key>
	<Key keycode="KP_PGDN" left={repeat()} top={top()}>6</Key>
</div>
